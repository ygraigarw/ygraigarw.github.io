...
%\extrainfo{June 2025}                   % optional, remove / comment the line if not wanted
\photo[54pt][0.4pt]{PhilipJonathan2018.png}       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
Philip Jonathan is a semi-retired statistical modeller at the School of Mathematical Sciences at Lancaster University, UK. His current research is reported at www.lancs.ac.uk/$\sim$jonathan. He has more than 35 years experience in statistical modelling of physical systems, particularly the ocean environment, and a background in applied mathematics and physics. He is particularly interested in characterising extreme ocean environments, and the development of methodology for good design and re-analysis of offshore and coastal infrastructure. He has published on the development of methods for large-scale non-stationary marginal extreme value modelling with multidimensional covariates, and non-stationary extensions of multivariate, spatial and time-series extreme value methods, and applied these widely. He has developed and refined estimators summarising the tails of distributions, including return values, associated values and environmental design contours in the presence of uncertainty. His long-standing interests include Bayesian uncertainty analysis for complex systems, Bayesian inference for optimal design and probabilistic inversion in remote sensing, multivariate prediction and computational statistics generally. He has also published on ion physics, chemical kinetics, multivariate analysis, manufacturing process optimisation, chemometrics and quantitative structure--activity relationships, single pixel cameras, wave radar measurement, time-series and change-point analysis, volcanology and ancient writing systems. Illustrative references include:

\setlength{\parskip}{0.2em}

E. J. Watts, R. Rees, \textbf{P. Jonathan} et al.  Afar triple junction fed by single, asymmetric mantle upwelling. Nat. Geosci. https://doi.org/10.1038/s41561-025-01717-0, 2025.
...
\cventry{2018--2025}{Chief Statistician}{Shell Projects \& Technology}{London, UK}{}{}
...
\cventry{2026--date}{J. Guntrip}{Ph.D., School of Mathematical Sciences, Lancaster University, UK}{}{}{}
\cventry{2022--2026}{M. Speers}{Ph.D., Department of Mathematics \& Statistics, Lancaster University, UK}{}{}{}
\cventry{2022--2025}{T. Newman}{Ph.D., Department of Mathematics \& Statistics, Lancaster University, UK}{}{}{}
...
\cvitem{External examination of PhDs}{Mathematical Sciences (Oslo, 2024); Mathematical Sciences (Durham, 2020); Civil Engineering and Environmental Science (Imperial College, 2017); Chemical Engineering and Advanced Materials, Newcastle, 2016); Mathematical Sciences (Trondheim, 2015); Transport Studies (Leeds, 2011); Process Analytics and Control Technology (Newcastle, 2003). Also acted as Internal Examiner for Lancaster PhDs on numerous occasions since 2018.}

\section{Consultancy activities}

Since 2024 I have undertaken a limited amount of consultancy work.

\cvitem{JBA / Environment Agency}{On behalf of Lancaster University, support for review and update of flood and coastal defence Joint Probability Guidance (2024-).} 

\cvitem{IOGP}{On behalf of Lancaster University, masterclass on applied extreme value analysis for metocean design (2026).} 

%\setlength{\parskip}{0em}

\section{Yn y Gymraeg}
Modelydd ystadegol yn Ysgol Gwyddorau Mathemategol Prifysgol Caerhirfryn yw Philip Jonathan. Mae'n astudio sistemau amgylcheddol yn cynnwys eithafon stormydd morol a gwasgariad nwyon atmosfferig gan ddefnyddio dulliau gwerthoedd eithafol a gofodol-amserol Bayesaidd. Gweler \url{www.lancs.ac.uk/~jonathan}.

\section{Publications}
Publications are sorted first by year (in reverse), then by author and finally if necessary by title. 
\vspace{5pt}

2026: M. Chung, R. Wada, J. Rohmer and \textbf{P. Jonathan}. Temporally coherent modeling of tropical cyclone compound flooding for reliable coastal hazard estimation (submitted to Nat. Hazards Earth Syst. Sci. in March 2026, preprint at \url{www.lancs.ac.uk/~jonathan}).

2026: C. Leach, K. Ewans and \textbf{P. Jonathan}. Estimating changes in extreme quantiles over time, applied to desert temperatures (accepted by Stoch. Environ. Res. Risk Assess. in August 2026). arXiv:2603.07227.

2026: E. Mackay, J. Richards and \textbf{P. Jonathan}. Diagnostic tools for extreme value regression models (submitted to Extremes in June 2026). arXiv:2606.02676.

2026: M. Speers, J. A. Tawn and \textbf{P. Jonathan}. Sequential design for the efficient estimation of offshore structure failure probability. Ocean Eng. 349:123990. arXiv:2509.18319.

2026: E. Vanem, S. Dong, G. de Hauteclocque, T. B. Johannesen, T. Zhu, J. Prpic-Orsic, S. van Essen, K. Ewans, E. Mackay and \textbf{P. Jonathan}. Statistical modeling of the ocean environment. Annu. Rev. Stat. Appl. 13:1-28.

2025: C. Leach, K. Ewans and \textbf{P. Jonathan}. Changes over time in the 100-year return value of climate model variables. Ocean Eng. 324:120605. arXiv:2501.11650.

2025: E. Mackay, C. J. R. Murphy-Barltrop, J. Richards and \textbf{P. Jonathan}. Deep learning joint extremes of metocean variables using the SPAR model. J. Offshore Mech. Arct. Eng.  148:021201. arXiv:2412.15808.

2025: C. Murphy, R. Towe and \textbf{P. Jonathan}. Calibration of medium-range metocean forecasts for the North Sea. Appl. Ocean Res. 158:104538. arXiv:2503.21488.

2025: T. Newman, C. Nemeth, M. J. Jones and \textbf{P. Jonathan}. Probabilistic inversion modeling of gas emissions: a gradient-based MCMC estimation of Gaussian plume parameters. Ann. Appl. Stat. 19:2937-2956. arXiv:2408.01298.

2025: T. Newman, C. Nemeth, M. J. Jones and \textbf{P. Jonathan}. Deep learning surrogates for real-time gas emission inversion. arXiv:2506.14597.

2025: Rajpaul, V. M., Marr, C., \textbf{P. Jonathan} and Hughes, B. M. Economi Cymru: cyfraniad y gwyddorau mathemategol. Academi’r Gwyddorau Mathemategol. DOI: 10.5281/zenodo.17777109.
...
2025: E. J. Watts, R. Rees, \textbf{P. Jonathan}, D. Keir, R. N. Taylor, M. Siegburg, E. L. Chambers, C. Pagli, M. J. Cooper, A. Michalik, J. A. Milton, T. K. Hincks, E. F. Gebru, A. Ayele, B. Abebe and T. M. Gernon.  Afar triple junction fed by single, asymmetric mantle upwelling. Nat. Geosci. https://doi.org/10.1038/s41561-025-01717-0.
...
1994: \textbf{P. Jonathan}, P. H. Taylor, and P. A. Tromans. Storm waves in the northern North Sea, BOSS '94, 7th International Conference on the Behaviour of Offshore Structures, 12-15 July 1994, Massachusetts, USA. Proceedings published by Pergamon, ISBN 0 08 041914 3, Vol 2, p.481.
...
With Patrik Bohlinger and colleagues: The EnvEx environmental extremes software.

With Marios Christou and Kevin Ewans: On the tri-spectrum for ocean wave characterisation.

With Callum Leach and Kevin Ewans: Practical return value prediction using Bayesian model averages.

With Ed Mackay and Kevin Ewans: A mathematical overview of extreme value modelling in ocean engineering.
