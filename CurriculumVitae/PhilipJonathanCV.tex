...
With Callum Leach and Kevin Ewans: Evidence for non-linear changes in future extreme temperatures from CMIP6 climate models.

With Ed Mackay and Jordan Richards: Diagnostics for SPAR model for multivariate extremes.

With Ed Mackay and Kevin Ewans: A mathematical overview of extreme value modelling in ocean engineering.

With Matt Speers and Paul Taylor: Efficient sampling of the environment space for estimation of structural failure probability.
